...
let checkValidUsername = (array, username) => {
...
console.log(checkValidUsername(arrayOfUsername, username1));
console.log(checkValidUsername(arrayOfUsername, username2));
console.log(checkValidUsername(arrayOfUsername, username3));
