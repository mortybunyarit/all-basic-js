...
1. ให้ประกาศตัวแปรชื่อ fruits ด้วย keyword const โดยกำหนด value เป็น empty array
2. ให้เพิ่ม 'apple' เข้าไป ใน empty array นี้ จากนั้น console.log เพื่อดูความเปลี่ยนแปลง
3. ให้เพิ่ม 'banana' เข้าไปใน array นี้ จากนั้น console.log เพื่อดูความเปลี่ยนแปลง
5. ให้เพิ่ม 'orange' เข้าไปใน array นี้ โดยเมื่อ console.log จะต้องเห็นข้อมูลเรียงตัวแบบนี้ ['orange', 'apple', 'banana']
